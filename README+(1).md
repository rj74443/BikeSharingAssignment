...
## Conclusions
- The R-squared value of the train set is 83.2% whereas the test set has a value of 81.74% which suggests that our model broadly explains the variance quite accurately on the test set and thus we can conclude that it is a good model.
